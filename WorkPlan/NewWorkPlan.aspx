        ...
        <%--<section class="section_module mt20">
            <form class="mui-input-group">
                 ...
                 <div class="input-row clearfix">
                    ...
                    <div class="input fr">
                        <input type="text" name="cust_customer" readonly="readonly" fl="客户名称" id="cust_customer" class="text" placeholder="请选择客户名称" />
                        <i class="iconfont">&#xe64c;</i>
                    </div>
                </div>
                <div class="input-row clearfix">
                    ...
                    <div class="input fr">
                        <input type="text" name="link_name" readonly="readonly" fl="联系人" id="link_name" class="text" placeholder="请选择联系人" />
                        <i class="iconfont">&#xe64c;</i>
                    </div>
                </div>
                <div class="input-row clearfix" style="display:none">
                    ...
                    <div class="input fr">
                        <span id="link_position" class="text"></span>
                    </div>
                </div>
            </form>
        </section>--%>
